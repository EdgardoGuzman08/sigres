...
if($cart->total_items() <= 0){
    header("Location: /productos/inicio");
}
...
$query = $db->query("SELECT clientes.Nombre,clientes.Telefono,clientes.Correo,clientes_direcciones.direccion FROM clientes CROSS JOIN clientes_direcciones WHERE idregistro = ".$_SESSION['sessCustomerID']);
...
<div class="panel-body">
    ...
    <div class="footBtn">
        <a href="/productos/inicio" class="btn btn-warning"><i class="glyphicon glyphicon-menu-left"></i> Continue Comprando</a>
